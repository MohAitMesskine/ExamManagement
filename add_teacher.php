                            ...
                            <form class="form-horizontal" method="POST" action="pages/save_teacher.php"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="matricule" class="form-control"
                                                placeholder="Matricule" id="event" 
                                                required="">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="tfname" class="form-control"
                                                placeholder="First Name" id="event" onkeydown="return alphaOnly(event);"
                                                required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="tlname" id="lname" class="form-control" id="event"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <select type="text" name="classname" id="class_id" class="form-control"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <select type="text" name="subjectname" id="subject_id" class="form-control"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="tcontact" class="form-control"
                                                placeholder="Contact Number" id="tbNumbers" minlength="10"
